...
combined_nmds_species_biplot <- ggplot(combined_nmds_scores, aes(x = NMDS1, y = NMDS2)) +
  ...
  theme_classic() +
  labs(title = "NMDS comparing Dangermond seedbank and aboveground diversity", caption = "Seedbank community is significantly different from aboveground diversity (perMANOVA p = 0.001)")
